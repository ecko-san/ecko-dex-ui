...
const StakeInfo = () => {
  return (
    <FlexContainer className="column" gap={16}>
      <Label>The eckoDEX Staking tool accomplishes two main purposes:</Label>
      ...
      <Divider />
      <Label>
        Adding more KDX to your locked position, will simply increase your waiting time proportionally, and it will also activate a 3% flat penalty fee on any
      ...
      <List
        listType="circle"
        items={[
          'w denotes waiting time adjustment when adding more locked KDX;',
